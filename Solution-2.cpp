...
void directory_menu()
{
	...
	XY(40, 11); cout << "(0) Выход из базы данных." << endl;
	XY(40, 12); cout << "(1) Вывод из файла." << endl;
	XY(40, 13); cout << "(2) Просмотр базы данных." << endl;
	XY(40, 14); cout << "(3) Редактирование информации." << endl;
	XY(40, 15); cout << "(4) Добавление информации." << endl;
	XY(40, 16); cout << "(5) Поиск по введенному названию." << endl;
	XY(40, 17); cout << "(6) Сохранение информации." << endl;
	...
	while (base_menu != 0)
	{
		...
		case 5:
			...
			if (H != 0)
			{
				...
				cout << "Данные не добавлены!" << "Нельзя осуществить поиск!" << endl;
		...
		default:
			cout << "Неверно введён номер меню!" << endl;
			system("pause");
			system("cls");
			directory_menu();
			break;
